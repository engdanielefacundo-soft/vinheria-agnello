...
1. **Início (`index.html`)**
   ...
   - **Convite à Loja Física:** Chamada convidativa para visitar o espaço na Bela Vista e desfrutar de degustação no balcão.
...
5. **Contato (`src/pages/contato.html`)**
   ...
   - **Localização Real via Iframe:** Mapa interativo do Google Maps centrado no tradicional bairro da Bela Vista, em São Paulo - SP.
...
<table align="center">
  <tr>
    <td align="center">
      <a href="https://github.com/engdanielefacundo-sof">
  ...
  <tr>
    <td align="center">
      ...
      <a href="https://github.com/engdanielefacundo-sof" target="_blank">
